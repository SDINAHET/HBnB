document.addEventListener("DOMContentLoaded", () => {
  ...
  const protectedMessage = document.getElementById("protected-message"); // Conteneur pour le message protégé
    ...
    loginForm.addEventListener("submit", async (event) => {
      ...
      try {
        ...
        if (data) {
          ...
          // Récupérer le message protégé après la connexion
          ...
          try {
            ...
            if (response.ok) {
              ...
              // Afficher le message protégé dans le conteneur
              protectedMessage.textContent = protectedData.message;
            } else {
              console.error("Failed to fetch protected data:", response.statusText);
              protectedMessage.textContent = "Failed to load protected message.";
            }
          } catch (error) {
            console.error("Error fetching protected data:", error);
            protectedMessage.textContent = "Error occurred while fetching protected data.";
          }
