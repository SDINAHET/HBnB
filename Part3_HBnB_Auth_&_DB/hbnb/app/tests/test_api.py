...
if __name__ == "__main__":
    ...
    # Stocker les valeurs nécessaires dans un fichier JSON
    data_to_store = {
        "user_id": APITestCase.user_id,
        "token": APITestCase.token,
        "amenity_id_1": APITestCase.amenity_id_1,
        "amenity_id_2": APITestCase.amenity_id_2,
        "place_id": getattr(APITestCase, 'place_id', None)
    }
